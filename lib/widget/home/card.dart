...
class StockGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<StockViewModel>(builder: (context, stockViewModel, child) {
      ...
      return Padding(
        padding: const EdgeInsets.only(top: 8.0), // Ajusta este padding
        child: GridView.builder(
          ...
          padding: const EdgeInsets.symmetric(
              horizontal: 8.0, vertical: 0.0), // Remueve paddings innecesarios
          shrinkWrap: true,
          ...
          itemBuilder: (context, index) {
            ...
            return Container(
              margin: const EdgeInsets.symmetric(
                  horizontal: 6.0, vertical: 0.0), // Ajusta este margin
              child: Card(
                elevation: 4,
                child: InkWell(
                  onTap: () {
